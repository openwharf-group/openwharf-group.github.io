...
5. Now you can call [Nacos Open API](//nacos.io/docs/open-api.html) to publish a configruation to the Nacos server. Assume the dataId is `example`, and content is `useLocalCache=true`.
