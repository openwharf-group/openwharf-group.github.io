...
For more details about Nacos Spring Boot: [nacos-spring-boot-project](//github.com/nacos-group/nacos-spring-boot-project/wiki/spring-boot-0.2.2-%E4%BB%A5%E5%8F%8A-0.1.2%E7%89%88%E6%9C%AC%E6%96%B0%E5%8A%9F%E8%83%BD%E4%BD%BF%E7%94%A8%E6%89%8B%E5%86%8C).
...
Follow instructions in [Nacos Quick Start](//nacos.io/docs/quick-start.html) to download Nacos and start the Nacos server.
...
Sample project: [nacos-spring-boot-config-example](//github.com/nacos-group/nacos-examples/tree/master/nacos-spring-boot-example/nacos-spring-boot-config-example)
...
**Note**: Version [0.2.x.RELEASE](//mvnrepository.com/artifact/com.alibaba.boot/nacos-config-spring-boot-starter) is compatible with the Spring Boot 2.0.x line. Version [0.1.x.RELEASE](//mvnrepository.com/artifact/com.alibaba.boot/nacos-config-spring-boot-starter) is compatible with the Spring Boot 1.x line.
...
6. Call [Nacos Open API](//nacos.io/docs/open-api.html) to publish a configuration to the Nacos server. Assume the dataId is `example`, and the content is `useLocalCache=true`.
...
Sample project: [nacos-spring-boot-discovery-example](//github.com/nacos-group/nacos-examples/tree/master/nacos-spring-boot-example/nacos-spring-boot-discovery-example)
...
**Note**: Version [0.2.x.RELEASE](//mvnrepository.com/artifact/com.alibaba.boot/nacos-discovery-spring-boot-starter) is compatible with the Spring Boot 2.0.x line. Version [0.1.x.RELEASE](//mvnrepository.com/artifact/com.alibaba.boot/nacos-discovery-spring-boot-starter) is compatible with the Spring Boot 1.x line.
...
5. Call [Nacos Open API](//nacos.io/docs/open-api.html) to register a service called `example` to the Nacos server.
