...
1. Deploy Nacos, [ deployment reference ](//nacos.io/docs/quick-start.html);
...
The service configuration registered in the example is as follows, [ example reference ](//github.com/nacos-group/nacos-examples/tree/master/nacos-spring-cloud-example/nacos-spring-cloud-discovery-example ).
