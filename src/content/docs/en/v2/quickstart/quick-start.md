...
## 0.Choose Version
You can see the introduction of each version at [release notes](//github.com/alibaba/nacos/releases) or [blog](//nacos.io/en/blog/index.html), the current recommended version is 2.1.1.
...
2. 64bit JDK 1.8+: [downloads](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html), [JAVA_HOME settings](//docs.oracle.com/cd/E19182-01/820-7851/inst_cli_jdk_javahome_t/).
3. Maven 3.2.x+: [downloads](//maven.apache.org/download.cgi), [settings](//maven.apache.org/settings.html).
...
Select the latest stable version from //github.com/alibaba/nacos/releases
