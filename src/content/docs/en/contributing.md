...
#### Read Nacos [Code of Conduct](//github.com/alibaba/nacos/blob/develop/style/codeStyle.md), and make sure your IDE has set code style and install plugin.
...
* Follow the checklist in the [pull request template](//nacos.io/en/docs/pull-request.html).
...
#### Familiar with [Markdown](//www.markdownguide.org/getting-started)

#### Familiar with [docsite](//github.com/txd-team/docsite), at least be able to complete local debugging according to the [document README.md](//github.com/nacos-group/nacos-group.github.io).
...
##### Maintainability - Comply with our [Code of Conduct](//github.com/alibaba/nacos/blob/develop/style/codeStyle.md), with an update frequency at least once every 3 months.
