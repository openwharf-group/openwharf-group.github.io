...
Deploy the Nacos cluster according to [the deploy document](//nacos.io/en/docs/deployment.html)
...
Reference for the Construction of the Overall Monitoring System [Nacos Monitoring Manual](//nacos.io/en/docs/monitor-guide.html)
