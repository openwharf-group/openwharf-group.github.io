...
[zip package](//github.com/alibaba/nacos/releases/download/1.3.0/nacos-server-1.3.0.zip)

[tar.gz package](//github.com/alibaba/nacos/releases/download/1.3.0/nacos-server-1.3.0.tar.gz)
